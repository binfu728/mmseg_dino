...
custom_imports = dict(
    ...
    imports=[
        'custom_models.dinov3_temporal_backbone_zjf',
        'custom_datasets.pastis_temporal_zjf',
    ])
...
model = dict(
    backbone=dict(
        arch='vit_small',
        checkpoint=
        '/mnt/ht2-nas2/00-model/00-fb/mmseg_data/weights/dinov3_vits16_pretrain_lvd1689m-08c60483.pth',
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        pipeline=[
            dict(img_size=256, n_frames=12, type='LoadPASTISRasterTemporal'),
    ...
    dataset=dict(
        ...
        pipeline=[
            ...
            dict(
                ...
                prob=0.5,
                type='RandomFlip'),
            dict(prob=0.75, type='PASTISRandomRotate90'),
            dict(type='PackSegInputs'),
        ],
        split='train',
        type='PASTISRasterTemporalDataset'),
...
work_dir = './work_dirs/dinov3s_m2f_pastis_zjf'
